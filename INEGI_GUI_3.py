...
def Busquedaa():
	v3=Toplevel(root)
	b=Button(v3, text="EDITAR",command=ControladorDeObjeto.editarObjeto(clase))    #def funcion de editar
	b1= Button(v3, text="MOSTRAR")
	b2= Button(v3, text="ELIMINAR")
	b3= Button(v3, text="AGREGAR")
	b.pack()
	b1.pack()
	b2.pack()
	b3.pack()
...
if opcion=="Departamentos":
	
if opcion=="Estadisticas":
	
if opcion=="Informacion de la Empresa":
	
if opcion=="Fundaciones":
